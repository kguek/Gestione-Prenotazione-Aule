...
public class FileManagerTest {
        ...
        public void testSalvaECaricaPrenotazioni(@TempDir Path tempDir) {
                ...
                prenotazioniDaSalvare
                                .add(new Prenotazione(LocalDate.now(), 10, 12, "Mario Rossi", "Lezione di Matematica",
                                                aulaDid));
                AulaLab aulaLab = new AulaLab(202, 30);
                prenotazioniDaSalvare
                                .add(new Prenotazione(LocalDate.now(), 14, 16, "Luigi Bianchi",
                                                "Laboratorio di Informatica", aulaLab));
