...
public class GestionePrenotazioniTest {
    ...
    public void testPrenotazione() {
        ...
        Prenotazione p1 = new Prenotazione(LocalDate.now().plusDays(1), 10, 12, "Mario Rossi", "Lezione di Matematica",
                aulaTest);
    ...
    public void testPrenotazioneConflitto() {
        ...
        Prenotazione p1 = new Prenotazione(LocalDate.now().plusDays(1), 10, 12, "Mario Rossi", "Lezione di Matematica",
                aulaTest);
        Prenotazione p2 = new Prenotazione(LocalDate.now().plusDays(1), 11, 13, "Luigi Bianchi", "Lezione di Fisica",
                aulaTest);
        gestione.addPrenotazione(p1);
    ...
    public void testPrenotazioneStessoOrarioAulaDiversa() {
        ...
        Prenotazione p1 = new Prenotazione(LocalDate.now().plusDays(1), 10, 12, "Mario Rossi", "Lezione di Matematica",
                aula1);
        Prenotazione p2 = new Prenotazione(LocalDate.now().plusDays(1), 10, 12, "Luigi Bianchi", "Lezione di Fisica",
                aula2);
        gestione.addPrenotazione(p1);
        gestione.addPrenotazione(p2);
    ...
    public void testModificaPrenotazione() {
        ...
        Prenotazione p2 = new Prenotazione(LocalDate.now().plusDays(1), 11, 13, "Mario Rossi", "Lezione di Matematica",
                aulaTest);
        ...
        assertTrue(gestione.getPrenotazioni().contains(p2), "La prenotazione dovrebbe essere stata modificata.");
        assertFalse(gestione.getPrenotazioni().contains(p1), "La prenotazione vecchia non dovrebbe essere presente.");
    }
}